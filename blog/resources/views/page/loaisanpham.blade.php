                                ...
                                <div class="col-sm-4">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-body">
                                            ...
                                            <p class="single-item-price" style="font-size: 18px">
                                                @if($other->promotion_price !=0)
                                                    <span class="flash-del">{{number_format($other->unit_price)}} đồng</span>
                                                    <span class="flash-sale">{{number_format($other->promotion_price)}} đồng</span>
                                                @else
                                                    <span>{{number_format($other->unit_price)}} đồng</span>
                                                @endif
                                            </p>
                                        </div>
                                        <div class="single-item-caption">
                                            <a class="add-to-cart pull-left" href="{{route('themgiohang',$other->id)}}"><i class="fa fa-shopping-cart"></i></a>
                                            <a class="beta-btn primary" href="{{route('chitietsanpham',$other->id)}}">Chi tiết <i class="fa fa-chevron-right"></i></a>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                </div>
